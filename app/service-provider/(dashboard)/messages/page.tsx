...
interface BookingWithUnread extends ProviderBookingCardData {
    unread: number;
}
...
export default function ProviderMessagesPage() {
    ...
    const filtered = bookings.filter((b) => {
        const name = b.user_id?.fullname?.toLowerCase() ?? "";
    ...
    return (
        <div className="flex flex-col gap-6">
            <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Chat with your customers</p>
            </div>
                        ...
                        {!loading && filtered.length === 0 && (
                            <div className="flex flex-col items-center justify-center h-full py-16 gap-3">
                                ...
                                <p className="text-xs text-gray-300 text-center px-6">
                                    Customers will message you through their bookings
                                </p>
                            </div>
                        )}
                        ...
                        {filtered.map((booking) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-3.5 text-left transition-colors hover:bg-orange-50/50 border-b border-gray-50 ${
                                        isActive ? "bg-orange-50 border-l-2 border-l-[#EE7A40]" : ""
                                    }`}
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <span className={`text-[10px] font-semibold capitalize px-1.5 py-0.5 rounded-full mt-1 inline-block ${
                        ...
                        <>
                            ...
                            <div className="flex-1 overflow-hidden">
                                <ChatWindow
                                    ...
                                    partnerName={selected.user_id?.fullname || "Customer"}
                                    partnerAvatar={selected.user_id?.imageUrl}
